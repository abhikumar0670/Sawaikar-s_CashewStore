...
const Wishlist = () => {
  ...
  // Handler to remove item from wishlist with toast
              ...
              <div key={item.id} className="wishlist-item">
                ...
                <div className="item-details">
                  ...
                  <div className="item-pricing">
                    <span className="current-price"><FormatPrice price={item.price} /></span>
                    <span className="original-price"><FormatPrice price={item.originalPrice} /></span>
